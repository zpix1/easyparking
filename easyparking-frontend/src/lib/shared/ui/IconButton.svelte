...
<script lang="ts">
    ...
    const icons: Record<IconType, string> = {
      star_inactive:
        `<g transform="matrix(0.025591, 0, 0, 0.025591, 3.963432, 3.963463)">
      ...
      pencil:
        `<g transform="matrix(0.039807, 0, 0, 0.039807, 5.373878, 5.120311)">
...
<button class={icon} on:click={onClick}>
  <svg class={icon} viewBox="0 0 32 32" width="32px" height="32px" xmlns="http://www.w3.org/2000/svg">
    {@html displayIcon}
  </svg>
</button>
